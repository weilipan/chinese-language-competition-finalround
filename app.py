...
def draw_page(page_name):
    title = f"113年度臺北市國語文競賽-{page_name}第二階段抽籤作業"
    
    # 構建對應檔案的路徑，例如 'lists/國中演說.xlsx'
    ...
    return render_template('draw_page.html', title=title, data=data, draw_button_text="第1次抽籤", page_name=page_name)
